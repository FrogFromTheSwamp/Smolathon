export const isTranslations = {
    ...
    fields: {
        ...
        chooseBetweenCustomTextOrDocument: 'Veldu á milli þess að setja inn sérsniðna texta vefslóð eða tengja við annað skjal.',
    ...
    general: {
        ...
        copying: 'Afrita',
        copyRow: 'Afrita röð',
        copyWarning: 'Þú ert að fara að skrifa yfir {{to}} með {{from}} fyrir {{label}} {{title}}. Ertu viss?',
        create: 'Búa til',
        created: 'Búið til',
        createdAt: 'Búið til',
        ...
        currentlyEditing: 'er núna að breyta þessu skjali. Ef þú tekur yfir munu þeir verða hindraðir frá því að halda áfram að breyta og gætu líka misst óvistaðar breytingar.',
        custom: 'Sérsniðið',
        dark: 'Dökkt',
        ...
        noResults: 'Ekkert {{label}} fannst. Annað hvort eru engin {{label}} til eða engin passa við síurnar sem þú tilgreindir hér að ofan.',
    ...
    version: {
        ...
        aboutToRevertToPublished: 'Þú ert að fara að snúa breytingum þessa skjals til baka í útgefna ástandið. Ertu viss?',
